...
def code2040step4():
	...
	str = "".join(noPrfArray)
	json_string = '{"token" : "32003a47cded737d82e38ec1fc226905", "array" : "'+str+'"}'
	parsed_json = json.loads(json_string)
	r = requests.post('http://challenge.code2040.org/api/prefix/validate', json = parsed_json, headers = headers)
	print(r.text)
